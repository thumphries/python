...
# the contestant earns a positive score..." — an excerpt from contest
# rules.
#
...
# 0
#
# Note In the first example the participant on the 5th place earned 7
...
params = map(int, sys.stdin.readline().rstrip().split())
n = params[0]
k = params[1]
